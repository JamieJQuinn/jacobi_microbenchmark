...
void run_jacobi(real *p, const real* b, const real D_x, const real D_y, const real B, const struct JacobiParams* jp) {
...
int main(int argc, char* argv[]) {
  ...
  clock_t start = clock();
  const struct JacobiParams jp = {NX, NY, MAX_ITERATIONS};
  run_jacobi(p, b, D_x, D_y, B, &jp);
